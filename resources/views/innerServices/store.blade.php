        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('data.create', $id) }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control @error('icon') is-invalid @enderror"
                                        style="padding: 10px;" id="image" name="image" value="{{ old('icon') }}">
                                    @error('icon')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor " id="para" name="para">{{ old('home_para') }}</textarea>
